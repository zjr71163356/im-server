...
// Source: /home/tyrfly/im-server/pkg/protocol/pb/logicpb/device.int_grpc.pb.go
...
import (
	context "context"
	logicpb "im-server/pkg/protocol/pb/logicpb"
	reflect "reflect"
...
func (m *MockDeviceIntServiceClient) ConnSignIn(ctx context.Context, in *logicpb.ConnSignInRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceIntServiceClient) Offline(ctx context.Context, in *logicpb.OfflineRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// ConnSignIn mocks base method.
func (m *MockDeviceIntServiceServer) ConnSignIn(arg0 context.Context, arg1 *logicpb.ConnSignInRequest) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
...
// Offline mocks base method.
func (m *MockDeviceIntServiceServer) Offline(arg0 context.Context, arg1 *logicpb.OfflineRequest) (*emptypb.Empty, error) {
	m.ctrl.T.Helper()
